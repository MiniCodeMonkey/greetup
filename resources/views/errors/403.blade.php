<x-layouts.app :title="'403 — ' . \App\Models\Setting::get('site_name', config('app.name', 'Greetup'))">
    <div class="relative flex min-h-[calc(100vh-12rem)] items-center justify-center px-4">
        ...
        <div class="relative z-10 text-center">
            <p class="text-[44px] font-medium leading-none text-neutral-400">403</p>
            <h1 class="mt-4 text-[22px] font-medium text-neutral-900">You don't have access to this page</h1>
            <p class="mt-2 text-base text-neutral-500">You might need to join this group or have a different role to view this content.</p>
