...
class UpdateEventRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $this->isWithinEditingWindow($event);
    }

    /**
     * Check if the event is still within the editing window (24 hours after end/start).
     */
    private function isWithinEditingWindow(Event $event): bool
    {
