...
class UpdateGroupSettingsRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('editSettings', $this->route('group'));
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['required', 'string', 'max:255', 'alpha_dash', Rule::unique('groups', 'slug')->ignore($group->id)],
            ...
            'membership_questions.*.id' => ['nullable', 'integer'],
    ...
    public function messages(): array
    {
        return [
            ...
            'slug.required' => 'A group URL slug is required.',
